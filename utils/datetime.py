...
EXTRACT_DATETIME_FORMATS = [
    rf"""\D(IMG|PXL|VID){SEPARATOR}{YEAR}{MONTH}{DAY}{SEPARATOR}{HOUR}:{MINUTE}:{SECOND}\D""",
    rf"""\D(IMG|PXL|VID){SEPARATOR}{YEAR}{MONTH}{DAY}{SEPARATOR}{HOUR}{MINUTE}{SECOND}\D""",
    rf"""\D(IMG|PXL|VID){SEPARATOR}{YEAR}{MONTH}{DAY}{SEPARATOR}{HOUR}{MINUTE}{SECOND}{MILLISECOND}\D""",
    rf"""\D(IMG|VID){SEPARATOR}{YEAR}{MONTH}{DAY}\D""",
    rf"""\D{DAY}{SEPARATOR}{MONTH_NAME}{SEPARATOR}{YEAR}\D""",
    rf"""\D{YEAR}{MONTH}{DAY}{SEPARATOR}{HOUR}{MINUTE}{SECOND}\D""",
    rf"""\D{YEAR}{MONTH}{DAY}{SEPARATOR}{HOUR}{MINUTE}{SECOND}{SEPARATOR}{MILLISECOND}\D""",
    rf"""\D{YEAR}{SEPARATOR}{MONTH}{SEPARATOR}{DAY} AT {HOUR}{SEPARATOR}{MINUTE}{SEPARATOR}{SECOND}\D""",
    rf"""\D{YEAR}{SEPARATOR}{MONTH}{SEPARATOR}{DAY}\D""",
    rf"""\D{YEAR}{SEPARATOR}{MONTH}{SEPARATOR}{DAY}T{HOUR}{SEPARATOR}{MINUTE}{SEPARATOR}{SECOND}{SEPARATOR}{MILLISECOND}\D""",
    rf"""\D{YEAR}{SEPARATOR}{MONTH}{SEPARATOR}{DAY}{SEPARATOR}{HOUR}:{MINUTE}:{SECOND}\D""",
    rf"""\D{YEAR}{SEPARATOR}{MONTH}{SEPARATOR}{DAY}{SEPARATOR}{HOUR}H{MINUTE}M{SECOND}S{MILLISECOND}\D""",
    rf"""\D{YEAR}{SEPARATOR}{MONTH}{SEPARATOR}{DAY}{SEPARATOR}{HOUR}{MINUTE}{SECOND}\D""",
    rf"""\D{YEAR}{SEPARATOR}{MONTH}{SEPARATOR}{DAY}{SEPARATOR}{HOUR}{SEPARATOR}{MINUTE}{SEPARATOR}{SECOND}\D""",
